...
As in the previous 2 projects, you will work in teams to tackle challenging datasets in the field of bioinformatics. Project 3 focuses on the 16S iTag (also known as amplicon) data associated with the **same sample depth** for which you analyzed metagenomics in the last project.

This project will focus more on your development and assessment of a pipeline as opposed to the previous projects that focused on biological results interpretation. **Your goal is to present your final pipeline with data supporting your final parameter choices.** This means you will need to run steps multiple times and compare the outputs.
...
## Data
Water was collected from various depths at Saanich Inlet and filtered through a 0.22 μm Sterivex filter to collect biomass. Total genomic DNA was extracted from these filters. Amplicon sequencing of the variable 4 (V4) region of the small subunit (16S) rRNA gene was then performed (primers 515F and 806R). These data were generated on the Illumina MiSeq platform with **2x300bp** technology.
...
## Pipeline
The general [mothur workflow](https://github.com/EDUCE-UBC/MICB405_project3/blob/master/Project3_workflow.Rmd) is available through GitHub.
