...
taxonomy = raw_input("Please enter the name of your taxonomy file.\n")
...
#taxonomic level
level = int(raw_input("Please enter the number for your taxonomic level of interest.\n" + 
"1 = Phylum\n" + "2 = Class\n" + "3 = Order\n" + "4 = Family\n" + "5 = Genus\n" + 
"6 = Species\n"))
...
shared = raw_input("Please enter the name of your shared file.\n")
